                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          child: RaisedButton(
                            child: Text("Edit",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold)),
                            onPressed: () {
                      ...
                      Expanded(
                          child: RaisedButton(
                            child: Text("Delete",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold)),
                            onPressed: () {
                      ...
                      Expanded(
                          child: RaisedButton(
                            child: Text("Cancel",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold),),
                            onPressed: (){
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 40.0,
                        child: FlatButton(
                          child: Text("Add Due",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold),),
                          onPressed: (){
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 40.0,
                        child: FlatButton(
                          child: Text("Collection",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold),),
                          onPressed: (){
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 40.0,
                        child: FlatButton(
                          child: Text("Current Due",style: TextStyle(fontSize: 19,color: Colors.black,fontWeight: FontWeight.bold),),
                          onPressed: (){
                            setState(() {
